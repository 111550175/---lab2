...
main(int argc, char* argv[])
{
    ...
    pointToPoint1.SetDeviceAttribute("DataRate", StringValue("3Mbps"));
    ...
    UdpEchoServerHelper echoServer1(98);
    ...
    UdpEchoClientHelper echoClient1(interfaces1.GetAddress(1), 98);
